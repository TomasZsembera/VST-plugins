<footer class="container bg-dark text-white">
    <div class="row">
        ...
        <!--Tel cislo mail a instagram-->
        <div class="col-25 text-left">
            <h4>Kontaktujte nás</h4>
            <p><i class="fa fa-envelope" aria-hidden="true"><a href="mailto:tomas.zsembera@student.ukf.sk">
                        tomas.zsembera@student.ukf.sk</a></i></p>
            <p><i class="fa fa-phone" aria-hidden="true"><a href="tel:0909500600"> 0909500600</a></i></p>
            <p><i class="fa fa-instagram" aria-hidden="true"><a href="https://www.instagram.com/whoistexx">
                        whoistexx</a></i></p>
        </div>
        <div class="col-25">
            <h4>Rýchle odkazy</h4>
    ...
    <div class="row">
        Created and designed by Tomáš Zsembera
    </div>
